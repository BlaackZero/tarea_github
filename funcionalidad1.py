...
print("Hora en Chile/Continental:", chile_time.strftime("%Y-%m-%d %H:%M:%S"))

# Obtener la hora actual en Japón
japan_timezone = pytz.timezone('Asia/Tokyo')
japan_time = datetime.datetime.now(japan_timezone)
print("Hora en Japón/Tokyo:", japan_time.strftime("%Y-%m-%d %H:%M:%S"))
...
print("Hora en Canada/Pacific:", canada_time.strftime("%Y-%m-%d %H:%M:%S"))